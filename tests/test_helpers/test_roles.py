...
@pytest.mark.parametrize('bad_role_type, expected_error_message', [
    ('bad_name', '\'bad_name\' is not a valid RoleType'),
    ('', '\'\' is not a valid RoleType'),
    (['not string and not RoleType'], 'Invalid exclude_role_type! str or RoleType expected. Got: list'),
])
