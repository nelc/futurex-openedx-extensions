...
docs_src = {
    ...
    'CourseStatusesView.get': {
        ...
        'description': 'The response will include the number of courses in the selected tenants for each status. The'
        ...
        '\nNote: the count includes all courses regardless of their visibility status.',
        'parameters': [
    ...
    'CoursesView.get': {
        ...
        ' selected tenants regardless of their visibility status.',
        'parameters': [
            common_parameters['tenant_ids'],
            query_parameter(
                'search_text',
    ...
    'LearnerCoursesView.get': {
        ...
        'description': 'Get the list of courses for a specific learner using the `username`. The caller must have'
        ' access to the learner\'s tenant through a tenant-role, or access to a course where the learner is enrolled'
        '.\n'
        '\nNote: this endpoint will return `404` when inquiring for a staff user; unless `include_staff` is set to `1`',
        'parameters': [
    ...
    'TotalCountsView.get': {
        ...
        'parameters': [
            ...
            query_parameter(
                ...
                '- `learners`: total number of learners in the selected tenants. Be aware that the same learner might'
