...
@cache_dict(
    timeout=settings.FX_CACHE_TIMEOUT_COURSE_ACCESS_ROLES, key_generator_or_name=cs.CACHE_NAME_ALL_COURSE_ACCESS_ROLES
)
...
class FXViewRoleInfoMixin(metaclass=FXViewRoleInfoMetaClass):
    ...
    @staticmethod
    @cache_dict(timeout=settings.FX_CACHE_TIMEOUT_VIEW_ROLES, key_generator_or_name=cs.CACHE_NAME_ALL_VIEW_ROLES)
