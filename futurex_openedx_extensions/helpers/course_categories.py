...
class CourseCategories:
    ...
    def reformat_categories_and_sorting(self, categories: Dict[str, Any], sorting: List[str]) -> None:
        ...
        for category_name, category_info in categories.items():
            ...
            reformated_categories[category_name] = {
                'label': category_info['label'],
                'courses': self.validated_courses(courses, silent_fail=True),
            }
        self.categories = reformated_categories
    ...
    def get_new_category_name(self) -> str:
        ...
        :rtype: str
        """
        if len(self.categories) < settings.FX_COURSE_CATEGORY_MAX_COUNT:
            base_name = 'category'
            index = 1
            while index < settings.FX_COURSE_CATEGORY_MAX_COUNT:
    ...
    def get_categories_for_course(self, course_id: str) -> Dict[str, Any]:
        """
        Get the all categories that include a specific course.
