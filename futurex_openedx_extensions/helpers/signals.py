...
def refresh_course_access_role_cache_on_save(sender, instance, **kwargs):  # pylint: disable=unused-argument
...
def refresh_course_access_role_cache_on_delete(sender, instance, **kwargs):  # pylint: disable=unused-argument
...
def refresh_view_allowed_roles_cache_on_save(sender, instance, **kwargs):  # pylint: disable=unused-argument
...
def refresh_view_allowed_roles_cache_on_delete(sender, instance, **kwargs):  # pylint: disable=unused-argument
