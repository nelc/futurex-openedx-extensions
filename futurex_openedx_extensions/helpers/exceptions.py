...
class FXExceptionCodes(Enum):
    ...
    INVALID_INPUT = 4001
    EXACTLY_ONE_TENANT_REQUIRED = 4002
    TENANT_ID_REQUIRED_AS_URL_ARG = 4003
    ...
    SITE_ALREADY_EXIST = 11002

    UPDATE_FAILED = 12001
    UPLOAD_FAILED = 12002

    BAD_CONFIGURATION_EXTERNAL_ID_EXTRACTOR = 13001
    DRAFT_CONFIG_DELETE_MISMATCH = 13002
    DRAFT_CONFIG_UPDATE_MISMATCH = 13003
    DRAFT_CONFIG_CREATE_MISMATCH = 13004
